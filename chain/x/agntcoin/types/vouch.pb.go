...
type Vouch struct {
	...
	// stake is the amount of ag3nt locked behind this vouch. Reputation
	// (PageRank) edge weights are derived from stake, making the trust graph
	// costly to Sybil. The stake is held (debited from the voucher) until the
	// vouch is removed via Unvouch.
...
var fileDescriptor_3456e40749257b95 = []byte{
	...
	0x0a, 0x8a, 0xf2, 0x4b, 0xf2, 0x85, 0x44, 0x60, 0x12, 0x7a, 0x70, 0x46, 0x99, 0xa1, 0x52, 0x35,
	...
	0x71, 0xb1, 0x95, 0xa7, 0x66, 0xa6, 0x67, 0x94, 0x48, 0xb0, 0x80, 0x4d, 0x82, 0xf2, 0x84, 0x44,
	0xb8, 0x58, 0x8b, 0x4b, 0x12, 0xb3, 0x53, 0x25, 0x58, 0xc1, 0xc2, 0x10, 0x8e, 0x93, 0xe7, 0x89,
	0x47, 0x72, 0x8c, 0x17, 0x1e, 0xc9, 0x31, 0x3e, 0x78, 0x24, 0xc7, 0x38, 0xe1, 0xb1, 0x1c, 0xc3,
	0x85, 0xc7, 0x72, 0x0c, 0x37, 0x1e, 0xcb, 0x31, 0x44, 0xe9, 0xa7, 0x67, 0x96, 0x64, 0x94, 0x26,
	0xe9, 0x25, 0xe7, 0xe7, 0xea, 0x57, 0xe5, 0xe7, 0x94, 0x24, 0xe6, 0x65, 0x67, 0x16, 0x17, 0x23,
	0xfc, 0x56, 0x81, 0x60, 0x96, 0x54, 0x16, 0xa4, 0x16, 0x27, 0xb1, 0x81, 0x3d, 0x69, 0x0c, 0x08,
	0x00, 0x00, 0xff, 0xff, 0x3e, 0x41, 0xb5, 0x82, 0x08, 0x01, 0x00, 0x00,
}
...
func (m *Vouch) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Stake != 0 {
		i = encodeVarintVouch(dAtA, i, uint64(m.Stake))
		i--
		dAtA[i] = 0x28
	}
	if m.Weight != 0 {
